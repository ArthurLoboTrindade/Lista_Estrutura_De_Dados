...
public class Lista_encadeada {
	...
	public void buscaN(int i) {
		buscaNRecursiva(this.primeiro, i, 0);
	}

	private void buscaNRecursiva(Celula c, int n, int i) {
		if (c == null) {
			System.out.println("Aluno não encontrado.");
			return;
		}
		if (c.getValor().getMatricula() == n) {
			System.out.println("Encontrado: " + c.getValor());
			return;
		}
		buscaNRecursiva(c.getProximo(), n, (i++));
	}
